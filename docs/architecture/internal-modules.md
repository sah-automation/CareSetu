...
- **Outbound Events Published:** `partner.registered`, `partner.verification_started`, `partner.credential_reviewed`, `partner.activated`, `partner.rejected`, `credential.invalidated`, `directory.search` (analytics).
