// PHASE-6 T05b (#318): public type-preset directory variant at /chemists
...
export const metadata: Metadata = {
  title: "Find verified chemists near you - CareSetu",
  description:
    "Search verified chemists in Daltonganj. Only activated, verified providers are listed.",
};
  ...
  return (
    <>
      ...
      <Suspense fallback={null}>
        <DirectoryBrowser presetType="chemist" />
      </Suspense>
      <PublicFooter />
    </>
  );
