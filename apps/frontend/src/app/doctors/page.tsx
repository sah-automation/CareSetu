// PHASE-6 T05b (#318): public type-preset directory variant at /doctors
...
export const metadata: Metadata = {
  title: "Find verified doctors near you - CareSetu",
  description:
    "Search verified doctors in Daltonganj. Only activated, verified providers are listed.",
};
  ...
  return (
    <>
      ...
      <Suspense fallback={null}>
        <DirectoryBrowser presetType="doctor" />
      </Suspense>
      <PublicFooter />
    </>
  );
